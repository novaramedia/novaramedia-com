<?php
  get_header();
  $wirePosts = json_decode(file_get_contents('http://wire.novaramedia.com/api/all/'));
?>
  ...
  <?php echoHomeWire($wirePosts->posts[0], $wirePosts->posts[1], $wirePosts->posts[2]); ?>
  ...
  <?php echoHomeWire($wirePosts->posts[3], $wirePosts->posts[4], $wirePosts->posts[5]); ?>
