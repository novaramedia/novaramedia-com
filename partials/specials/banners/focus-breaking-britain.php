...
<div class="padding-top-mid padding-bottom-mid margin-bottom-large background-neon-blue font-color-white" style="overflow: hidden; position: relative">
  <div style="position: absolute; top: 0; width: 100%; height: 100vh; overflow: hidden; z-index: 10; pointer-events: none; ">
  ...
  <div class="container">
    ...
    <div class="flex-grid-row">
      ...
      <div class="flex-grid-item flex-item-s-12 flex-item-xxl-6">  
        <a href="<?php echo $url; ?>"><p class="font-size-3">With growing rifts between its regions, how much longer can the UK survive? From the economic to the constitutional, this focus explores the divisions and contradictions within the union today.</p></a>
