  ...
  <div class="container">
    ...
    <div class="grid-row">
      ...
      <div class="grid-item is-s-24 is-xxl-12">
        <a href="<?php echo $url; ?>"><p class="fs-5-sans font-weight-bold font-color-green-racing mb-4">Planet B is a new podcast series from Novara Media which imagines a world that isn’t just saved from climate breakdown, but is renewed and transformed by the fight against it.</p></a>
