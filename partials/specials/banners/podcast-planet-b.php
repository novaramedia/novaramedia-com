...
<div class="pt-6 pb-6 font-color-white" style="overflow: hidden; position: relative">
  <div class="planet-b__background-container background-green-neon" style="position: absolute; top: 0; width: 100%; height: 100%; overflow: hidden; z-index: -10; pointer-events: none; ">
    <img class="planet-b__background-image planet-b__background-image-1" alt="" role="presentation" src="<?php
if ( ! defined( 'ABSPATH' ) ) {
    exit; // Exit if accessed directly
} echo get_bloginfo('stylesheet_directory') . '/dist/img/specials/planet-b-banner-background.png'; ?>" />
    <img class="planet-b__background-image planet-b__background-image-2" alt="" role="presentation" src="<?php
if ( ! defined( 'ABSPATH' ) ) {
    exit; // Exit if accessed directly
} echo get_bloginfo('stylesheet_directory') . '/dist/img/specials/planet-b-banner-background.png'; ?>" />
  </div>
  ...
  <div class="container">
    <div class="grid-row mb-4">
      <div class="grid-item is-xxl-24">
        <a class="font-size-9 text-uppercase font-weight-bold font-color-green-racing" href="<?php
if ( ! defined( 'ABSPATH' ) ) {
    exit; // Exit if accessed directly
} echo $url; ?>"><h4>Podcast</h4></a>
      </div>
    </div>
    <div class="grid-row">
...
if ( ! defined( 'ABSPATH' ) ) {
    exit; // Exit if accessed directly
} echo $url; ?>"><p class="font-size-11 font-weight-bold font-color-green-racing mb-4">Planet B is a new podcast series from Novara Media which imagines a world that isn’t just saved from climate breakdown, but is renewed and transformed by the fight against it.</p></a>
        <a href="<?php
if ( ! defined( 'ABSPATH' ) ) {
    exit; // Exit if accessed directly
} echo $url; ?>" class="ui-button ui-button--white">Listen Now</a>
      </div>
    </div>
  </div>
</div>
