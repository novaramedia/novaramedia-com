...
$posts_above_the_fold_ids = array();
        ...
        <div class="grid-row grid--nested">
          <div class="grid-item is-s-24 is-xxl-16">
            <div class="ui-border-bottom pb-4 mb-4">
              ...
              if ( is_numeric( $latest_featured_posts_ids[0] ) ) {
                get_template_part(
                  'partials/front-page/above-the-fold/featured-post-primary',
                  null,
                  array(
            ...
            <div class="grid-row grid--nested">
              <div class="grid-item is-xxl-12">
                ...
                if ( is_numeric( $latest_featured_posts_ids[2] ) ) {
                  get_template_part(
                    'partials/front-page/above-the-fold/latest-article--thumb-small',
                    null,
                    array(
          ...
          <div class=" grid-item is-s-24 is-xxl-8">
            ...
            if ( is_numeric( $latest_featured_posts_ids[1] ) ) {
              get_template_part(
                'partials/front-page/above-the-fold/featured-post-secondary',
                null,
                array(
            ...
            if ( is_numeric( $latest_featured_posts_ids[4] ) ) {
              get_template_part(
                'partials/front-page/above-the-fold/featured-post-tertiary',
                null,
                array(
