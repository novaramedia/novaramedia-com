    ...
    <div class="support-bar__open-view flex-grid-row padding-bottom-tiny">
      ...
      <div class="support-bar__open-actions-column flex-grid-item flex-item-s-2 flex-item-xxl-3">
        <div class="support-bar__open-actions-wrapper">
          ...
          <a href="<?php echo site_url('support/'); ?>" class="nm-button nm-button--white nm-button--small nm-button--inline only-desktop">Join our supporters</a>
        </div>
      </div>
      <div class="flex-grid-item flex-item-s-12 font-color-white only-mobile">
        <p class="margin-bottom-micro">We’re up against obscene wealth and influence in the media space. Our supporters keep us entirely free to access. We don’t have any ad partnerships or sponsored content.</p>
        <strong>If you can, donate one hour’s wage per month or whatever you can afford today.</strong>
        <div class="margin-top-tiny">
          <a href="<?php echo site_url('support/'); ?>" class="nm-button nm-button--white nm-button--small nm-button--inline">Join our supporters</a>
        </div>
      </div>
    </div>
    <div class="support-bar__closed-view flex-grid-row is-one-even-line-grid font-color-white text-links-underlined">
      <div class="flex-grid-item">
        <span class="only-desktop"><strong>Build people-powered media.</strong> We’re up against obscene wealth and influence in the media space.</span>
        <a href="<?php echo site_url('support/'); ?>" class="font-size-2 only-mobile">
          Fund independent, truthful journalism
        </a>
      </div>
      <div class="flex-grid-item">
        <a href="<?php echo site_url('support/'); ?>" class="only-desktop">
          Fund something better
        </a>
