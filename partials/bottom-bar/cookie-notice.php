...
?>
<div id="obligation-bar" data-testid="cookie-bar">
  <div class="container pt-2 pb-2">
    <div class="grid-row">
      ...
      <div class="grid-item is-xxl-6 text-align-right">
        <a id="obligation-accept" class="obligation-button ui-button ui-button--white ui-button--small" data-testid="cookie-bar-accept">Accept</a>
      </div>
    </div>
  </div>
</div>
