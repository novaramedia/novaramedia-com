...
<div class="flex-grid-row margin-bottom-basic">
  <div class="flex-grid-item flex-item-s-12 flex-offset-s-0 flex-item-m-5 flex-offset-m-1 flex-item-l-5 flex-offset-l-1 flex-item-xl-5 flex-offset-xl-1 flex-item-xxl-5 flex-offset-xxl-1 margin-bottom-basic">
  ...
  <div class="flex-grid-item flex-item-s-12 flex-item-m-5 flex-item-l-5 flex-item-xl-5 flex-item-xxl-5">
