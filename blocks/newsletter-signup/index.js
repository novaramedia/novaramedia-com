(() => {
  ...
  var e = {
      20: (e, t, r) => {
        ...
        function c(e, t, r) {
          ...
          t))
            a.call(t, o) && !i.hasOwnProperty(o) && (s[o] = t[o]);
          if (e && e.defaultProps)
  ...
  var c = r.n(i);
  const d = window.wp.url;
  var p = r(848);
  const m = JSON.parse('{"UU":"nm-wp/newsletter-signup"}');
  (0, o.registerBlockType)(m.UU, {
    edit: function (e) {
      let { attributes: t, setAttributes: r } = e;
      ...
      (0, n.useEffect)(() => {
        (async () => {
          try {
            const e = await c()({
              path: (0, d.addQueryArgs)('/wp/v2/newsletter', { per_page: 100 }),
            });
            i(e);
          } catch (e) {
            (console.error('Failed to fetch newsletters:', e), i([]));
          }
        })();
      }, []);
      const u = t.newsletter?.id || '';
      return (0, p.jsxs)('div', {
        ...m,
        children: [
          (0, p.jsx)('h3', {
          ...
          (0, p.jsx)('form', {
            children: (0, p.jsxs)('select', {
              ...
              onChange: (e) => {
                const t = o.find((t) => t.id === parseInt(e.target.value));
                r({ newsletter: t });
              },
              value: u,
              children: [
              ...
              children: [
                ...
                (0, p.jsxs)('div', {
                  ...
                  children: [
                    ...
                    (0, p.jsx)(l.TextControl, {
                      label: (0, s.__)('Custom Title', 'novaramedia-com'),
                      value: t.customTitle,
                      onChange: (e) => r({ customTitle: e }),
                      placeholder: (0, s.__)(
                    ...
                    (0, p.jsx)(l.TextareaControl, {
                      label: (0, s.__)('Custom Text', 'novaramedia-com'),
                      value: t.customText,
                      onChange: (e) => r({ customText: e }),
                      placeholder: (0, s.__)(
                        'Leave empty to use newsletter default',
                        'novaramedia-com'
                      ),
