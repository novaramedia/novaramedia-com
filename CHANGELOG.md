...
- Support form's frequency and amount controls are announced with their own labels by screen readers; duplicate IDs pointed each one at the first form's (#609)
