...
/**
 * Register taxonomy meta boxes for categories and focus taxonomies.
 *
 * @return void
 */
function nm_cmb_taxonomy_metaboxes() {
  ...
  $cmb_term->add_field(
    array(
      'name' => esc_html__( 'SoundCloud trailer URL', 'cmb2' ),
      'desc' => esc_html__( 'SoundCloud URL for a trailer embed e.g. https://api.soundcloud.com/tracks/123456 (optional)', 'cmb2' ),
      'id'   => $prefix . 'soundcloud_trailer',
      'type' => 'text_url',
    )
  );
  ...
  $cmb_term_focus_quote_group = $cmb_term_focus->add_field(
    array(
  ...
  $cmb_term_focus->add_group_field(
    $cmb_term_focus_quote_group,
    array(
      'name' => 'Quote copy',
      'id'   => 'copy',
      'type' => 'text',
