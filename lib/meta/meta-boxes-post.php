...
function nm_cmb_post_metaboxes() {
  ...
  $meta_boxes->add_field(
    ...
    // meta-validation.php bridges it onto the data-validation attributes.
    'options'    => array(
      'textarea_rows' => 5,
  ...
  $resources_metabox = new_cmb2_box(
       array(
  ...
  $resources_group_field = $resources_metabox->add_field(
       array(
    'id'      => $prefix . 'resources',
    'type'    => 'group',
    'options' => array(
  ...
  $resources_metabox->add_group_field(
       $resources_group_field,
      array(
    'name' => 'Resource Title',
    'id'   => 'title',
    'type' => 'text',
