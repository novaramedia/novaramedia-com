...
<form class="email-signup__form" action="<?php echo $netlify_url; ?>" method="post" target="_blank">
  ...
  <div class="email-signup__inputs">
    <div class="form-group mb-2">
      ...
      <input name="firstName" class="email-signup__name-input ui-input <?php echo $background_color === 'white' ? 'ui-input--border-gray' : ''; ?>" id="firstName" type="text" autocomplete="given-name" placeholder="First name" />
    </div>

    <div class="form-group mb-2">
      <label class="u-visuallyhidden" for="email">Email:</label>
      <input name="email" class="email-signup__email-input ui-input <?php echo $background_color === 'white' ? 'ui-input--border-gray' : ''; ?>" id="email" type="email" autocomplete="email" placeholder="Email" required />
    </div>
    ...
    <div class="email-signup__email-gdpr-group form-group layout-flex-align-center mb-2">
      ...
      <input name="gdpr" class="email-signup__email-gdpr-input ui-checkbox <?php echo $background_color === 'white' ? 'ui-checkbox--border-gray' : ''; ?> ml-2" id="newsletter-gdpr" type="checkbox" value="accepted" required/>
    </div>
