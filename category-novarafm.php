...
function render_podcast_links($podcast_url) {
?>
        ...
        <div class="grid-item offset-xxl-1 is-xxl-18">
          <div class="grid-row grid--nested">
            <div class="grid-item is-xxl-12">
              ...
              <h2 class="fs-7 mb-5"><?php echo get_the_title($post_id); ?></h2>
              <p class="fs-4-serif mb-5"><?php render_short_description($post_id); ?></p>
              ...
              ?>
              <h4 class="fs-6 mt-5 mb-3">Listen now on:</h4>
    ...
    <section class="container pt-9 pb-9">
      <div class="grid-row">
        ...
        <div class="grid-item offset-xxl-1 is-xxl-18">
          ...
          <div class="background-white ui-rounded-box pt-5 pb-5 pl-6 pr-6">
