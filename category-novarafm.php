        ...
        <div class="grid-item offset-xxl-1 is-xxl-18">
          <div class="grid-row grid--nested">
            <div class="grid-item is-s-24 is-xxl-12 mb-s-5">
              ...
              ?>
                <div class="fs-1 mt-1">
                  <a target=_blank rel="nofollow" href="https://resonancefm.com/">powered by: Resonance FM</a>
                </div>
              <?php
                }
              }
