...
class Carousel {
  ...
  setSizes() {
    ...
    _this.wrapperSpacing = _this.$wrapper.outerWidth(true) - _this.$wrapper.width();
    _this.innerContainerWidth = lodash_reduce__WEBPACK_IMPORTED_MODULE_4___default()(_this.$items, (sum, item) => {
      return sum + jquery__WEBPACK_IMPORTED_MODULE_0___default()(item).outerWidth(true);
    }, 0);
  ...
  animateToPosition(position) {
    ...
    const maxScroll = _this.innerContainerWidth - _this.carouselWidth + _this.wrapperSpacing;
...
class Utilities {
  ...
  displayTimeSince() {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.js-time-since').each((index, element) => {
      ...
      const m = moment__WEBPACK_IMPORTED_MODULE_1___default()(timestamp);
      if (m.isAfter(moment__WEBPACK_IMPORTED_MODULE_1___default()().subtract(5, 'hours'))) {
        $element.text(`| ${m.fromNow()}`);
      }
    });
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.js-time-since-unlimited').each((index, element) => {
      const $element = jquery__WEBPACK_IMPORTED_MODULE_0___default()(element);
      const timestamp = $element.data('timestamp');
      const m = moment__WEBPACK_IMPORTED_MODULE_1___default()(timestamp);
      $element.text(m.fromNow());
...
/* harmony import */ var _modules_LiveChecker_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/LiveChecker.js */ "./src/js/modules/LiveChecker.js");
...
class Site {
  constructor() {
    ...
    this.liveChecker = new _modules_LiveChecker_js__WEBPACK_IMPORTED_MODULE_5__.LiveChecker();
