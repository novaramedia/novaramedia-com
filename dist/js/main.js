...
/* harmony import */ var _modules_Analytics_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/Analytics.js */ "./src/js/modules/Analytics.js");
...
var Header = /*#__PURE__*/function () {
  ...
  _createClass(Header, [{
    ...
    value: function onReady() {
      ...
      if (jquery__WEBPACK_IMPORTED_MODULE_0___default()('body').hasClass('single')) {
    ...
    key: "showSinglePostTitle",
    value: function showSinglePostTitle() {
      var _this = this;

      _this.headerHeight = jquery__WEBPACK_IMPORTED_MODULE_0___default()('#header-main-wrapper').height();
      _this.$headerSinglePostTitle = jquery__WEBPACK_IMPORTED_MODULE_0___default()('#header-page-title');

      _this.setSinglePostTitleWidth();

      jquery__WEBPACK_IMPORTED_MODULE_0___default()(window).scroll(function () {
        if (jquery__WEBPACK_IMPORTED_MODULE_0___default()(window).scrollTop() > _this.headerHeight) {
...
var Search = /*#__PURE__*/function () {
  ...
  _createClass(Search, [{
    ...
    key: "fourzerofour",
    value: function fourzerofour() {
      var href = window.location.href; // remove url before WP
      ...
      request = request[request.length - 1]; // remove any dashes [in the case of a real permalink slug]
...
var Utilities = /*#__PURE__*/function () {
  ...
  _createClass(Utilities, [{
    ...
    value: function checkGDPRApproval() {
      var approvalCookie = js_cookie__WEBPACK_IMPORTED_MODULE_2___default().get('gdpr-approval');
      ...
      if (approvalCookie !== 'true') {
        ...
        jquery__WEBPACK_IMPORTED_MODULE_0___default()('#gdpr-accept').click(function () {
          js_cookie__WEBPACK_IMPORTED_MODULE_2___default().set('gdpr-approval', true);
