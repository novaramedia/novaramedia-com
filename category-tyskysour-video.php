...
/*
  ...
  [] Do I build the player loading thing for catchup?
*/
...
<div class="background-black font-color-white">
  <section class="container padding-top-small padding-bottom-small">
    <div class="flex-grid-row margin-bottom-micro">
      <div class="flex-grid-item flex-item-s-8 flex-item-l-4 flex-item-xxl-3">
      ...
      <div class="flex-grid-item flex-offset-s-0 flex-item-s-4 flex-offset-l-3 flex-item-l-5 flex-offset-xl-5 flex-item-xl-4 flex-offset-xxl-6 flex-item-xxl-3">
    ...
    <div class="tyskysour-archive__liveplayer">
      <div class="flex-grid-row">
        <div class="flex-grid-item flex-item-xxl-12">
          <div class="u-video-embed-container">
            <iframe class="youtube-player" type="text/html" src="<?php echo generate_youtube_embed_url('3eamDbTxwxw'); ?>"></iframe>
          </div>
        </div>
      </div>
    </div>
...
<div class="background-yellow">
  <section class="container padding-top-basic padding-bottom-small">
    <div class="flex-grid-row margin-bottom-basic">
      <div class="flex-grid-item flex-item-s-12">
        <h2 class="font-size-3">TyskySour not live right now? Catch up on the latest:</h2>
      </div>
    </div>
    <div class="flex-grid-row">
      <?php
...
<?php get_template_part('partials/support-section'); ?>
  ...
  <section id="about" class="container margin-top-large margin-bottom-large">
    <div class="flex-grid-row margin-bottom-small">
      <div class="flex-grid-item flex-item-s-12">
        <h4>What is TyskySour?</h4>
      </div>
    </div>
    <div class="flex-grid-row margin-bottom-small">
      ...
      <div class="flex-grid-item flex-item-s-6 flex-item-xxl-3">
        <a class="nm-button nm-button--red" href="https://www.youtube.com/subscription_center?add_user=novaramedia" target="_blank" rel="nofollow">Subscribe to our YouTube channel for notifications when we go live.</a>
      </div>
      <?php
        if ($podcast_url) {
      ?>
      <div class="flex-grid-item flex-item-s-6 flex-item-xxl-3">
        <a class="nm-button nm-button--white" href="<?php echo $podcast_url; ?>" target="_blank" rel="nofollow">Subscribe to the podcast feed for an audio-only catchup in your podcasting&nbsp;app</a>
      </div>
      <?php } ?>
    </div>
  </section>

  <section id="posts" class="container margin-top-basic">
    <div class="flex-grid-row margin-bottom-small">
      <div class="flex-grid-item flex-item-s-12">
