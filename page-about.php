...
?>
  <article id="page" class="container margin-top-small margin-bottom-large">
    ...
    <div class="grid-row margin-bottom-small">
      <div class="grid-item is-xxl-24">
        <h4 class="fs-3-sans font-uppercase font-bold">Team</h4>
      </div>
    </div>
    ...
    <div class="grid-row margin-bottom-small">
      <div class="grid-item is-xxl-24">
        <h4 class="fs-3-sans font-uppercase font-bold">Associates</h4>
      </div>
    </div>
    <div class="grid-row margin-bottom-small mobile-margin-bottom-none">
      <div class="grid-item is-m-12 is-xxl-6">
...
?>
    <div class="grid-row margin-bottom-small">
      <div class="grid-item is-xxl-24">
        <h4 class="fs-3-sans font-uppercase font-bold">Contact and information</h4>
      </div>
    </div>
    <div class="grid-row margin-bottom-small">
...
?>
    <div class="grid-row margin-bottom-small">
      <div class="grid-item is-xxl-24">
        <h4 class="fs-3-sans font-uppercase font-bold">Funding</h4>
      </div>
    </div>
...
?>
    <div class="grid-row margin-bottom-small">
      <div class="grid-item is-xxl-24">
        <h4 class="fs-3-sans font-uppercase font-bold">Regulation</h4>
      </div>
    </div>
...
?>
    <div class="grid-row margin-bottom-small">
      <div class="grid-item is-xxl-24">
        <h4 class="fs-3-sans font-uppercase font-bold">Legal</h4>
      </div>
    </div>
