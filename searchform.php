<div class="background-black padding-top-basic padding-bottom-basic">
  <div class="container">
    <div class="row">
      <div class="col col24">
        <form role="search" method="get" id="search-form" class="padding-small u-cf" action="http://local.novaramedia.com/">
          <input id="search-input" class="font-italic padding-tiny" type="text" value="" name="s" id="s">
