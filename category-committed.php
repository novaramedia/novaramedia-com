...
<main id="main-content" class="category-archive foreign-agent-archive">
  <style type="text/css">
    ...
    .foreign-agent-archive__subtitle {
      max-width: 500px;
    }

    .foreign-agent-archive__box {
      border: 2px solid;
      border-radius: 0px;
      padding: .8rem 1rem;
    ...
    .foreign-agent__serif-large {
      font-size: 27px;
      line-height: 1.25;
    }

    .foreign-agent__serif-medium {
      font-size: 21px;
      line-height: 1.25;
    }
  ...
  <section class="container pt-4 pb-4">
    <div class="flex-grid-row mb-4">
      ...
      <div class="flex-grid-item flex-item-xxl-12 text-align-center pt-6 pb-6">
        <h1 class="u-visuallyhidden">Commited</h1>
        ...
        <div class="foreign-agent-archive__subtitle-holder text-align-center mt-2">
        </div>
      </div>
    </div>
  </section>
