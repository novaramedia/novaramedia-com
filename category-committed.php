...
<div class="committed-archive__container committed__backgrounded">
  <section class="container">
    <div class="grid-row mb-4">
      <div class="grid-item is-xxl-12 is-m-10 mb-4 mt-4">
        <?php render_ui_tag( 'Podcast', home_url( 'category/audio/' ), 'no-border' ); ?>
      </div>
      <div class="grid-item is-xxl-12 text-align-center pt-10 pt-l-7 pt-s-12">
  ...
  <section class="container">
    <div class="grid-row mt-4 mb-4">
      <div class="grid-item offset-s-0 is-s-12 offset-l-1 is-l-10 offset-xxl-2 is-xxl-8">
    ...
    <div class="grid-row mt-4 mb-5">
      <div class="grid-item offset-s-0 is-s-12 offset-l-1 is-l-10 offset-xxl-2 is-xxl-8 font-serif committed__serif-large text-paragraph-breaks">
    ...
    <div class="grid-row mb-6 mb-s-4 committed-archive-listen__container">
      <div class="grid-item is-s-12 is-xxl-12 font-color-white committed-archive-listen__box">
  ...
  while ( have_posts() ) {
    ...
    ?>
      <article class="grid-row pt-6 pt-s-4" id="<?php echo $post->post_name; ?>">
        <div class="grid-item offset-s-0 is-s-12 offset-xxl-1 is-xxl-4 mobile-mb-4">
        ...
        <div class="grid-item offset-s-0 is-s-12 is-xxl-6">
          <?php the_post_thumbnail( 'col12-16to9', array( 'class' => 'index-post-thumbnail' ) ); ?>
        </div>
        <div class="grid-item offset-s-0 is-s-12 offset-l-2 is-l-8 offset-xl-3 is-xl-7 offset-xxl-3 is-xxl-6 mt-4 mb-4 mobile-mt-4 mobile-mb-4">
        ...
        <div class="grid-item offset-s-0 is-s-12 offset-l-2 is-l-8 offset-xl-3 is-xl-7 offset-xxl-3 is-xxl-6 font-serif mb-4 text-paragraph-breaks committed__serif-medium">
          <?php the_content(); ?>
        </div>
      </article>
    <?php
  ...
  <div>
    <div class="committed-credits__background pb-6 pt-6 font-color-white">
      ...
      <div class="grid-row committed-credits__info-row font-size-10">
        ...
        <!-- Reporters -->
        <div class="grid-item is-m-4 is-xxl-4 is-s-8 mb-s-5">
        ...
        <!-- Producers -->
        <div class="grid-item is-m-4 is-l-3 is-xxl-3 is-s-8 mb-s-5">
        ...
        <div class="grid-item is-m-8 is-l-4 is-xxl-3 mt-m-5 mt-s-0 is-s-8">
